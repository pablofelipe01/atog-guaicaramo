/* Genética Nelore CIA — half verde-claro block + cut-out Nelore extending past on right */
        ...
        <div style={{
          ...
          <div style={{ maxWidth: 560, color: "var(--g-beige)" }}>
            ...
            <p style={{
              ...
              <strong>reduce los ciclos de producción</strong> y acelera los
              resultados.<br />
